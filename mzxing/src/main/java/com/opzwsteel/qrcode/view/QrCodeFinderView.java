...
public final class QrCodeFinderView extends RelativeLayout {
    ...
    private LayoutParams layoutParamFrame;
    ...
    private void init(Context context) {
        ...
        mFrameRect = new Rect();
        layoutParamFrame = (LayoutParams) frameLayout.getLayoutParams();
        mFrameRect.left = (ScreenUtils.getScreenWidth(getContext()) - layoutParamFrame.width) / 2;
        mFrameRect.top = (ScreenUtils.getScreenHeight(getContext()) - layoutParamFrame.height) / 2;
        mFrameRect.right = mFrameRect.left + layoutParamFrame.width;
        mFrameRect.bottom = mFrameRect.top + layoutParamFrame.height;
    }
    ...
    public void changeToBarcode() {
        if (! isBarcode) {
            isBarcode = true;
            mFrameRect.bottom = mFrameRect.top + (layoutParamFrame.height>>1);
        }
        postInvalidate();
    }
    ...
    private void drawText(Canvas canvas, Rect rect) {
        ...
        String text = isBarcode?getResources().getString(R.string.bar_code_auto_scan_notification):getResources().getString(R.string.qr_code_auto_scan_notification);
