...
public final class CaptureActivityHandler extends Handler {
    ...
    public CaptureActivityHandler(CaptureActivity activity, boolean isbarcode, boolean isqrcode, Rect frameRect) {
        this.mActivity = activity;
        mDecodeThread = new DecodeThread(activity, isbarcode, isqrcode, frameRect);
        mDecodeThread.start();
