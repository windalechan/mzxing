...
final class DecodeHandler extends Handler {
    ...
    DecodeHandler(CaptureActivity activity, boolean barcode, boolean qrcode, Rect frameRect) {
...
//            PlanarYUVLuminanceSource source = new PlanarYUVLuminanceSource(mRotatedData, width, height,
//                    0,0, width, height, false);
            if (mFrameRect.right < width/scaleX && mFrameRect.bottom < height/scaleY) {
                PlanarYUVLuminanceSource source = new PlanarYUVLuminanceSource(mRotatedData, width, height,
                        (int)(mFrameRect.left*scaleX), (int)(mFrameRect.top*scaleY),
                        (int)(mFrameRect.width()*scaleX), (int)(mFrameRect.height()*scaleY), false);
